...
from ..optimizers.arima_optimizer import arima_optimizer
import pandas as pd
...
class ArimaModel:
    ...
    def __init__(self, seasonal_periods = 12, arima_params = None, seasonal_params = None, trend_params = None):
        ...
        self.seasonal_params = self.seasonal_params
    ...
    def fit(self, y_train):
        if (self.arima_params is None or 
            ...
            (self.arima_params, 
             ...
             self.trend_params,
             self.ensemble_weight) =  arima_optimizer(y_train, 
                                                      self.seasonal_periods,
                                                      self.arima_params, 
                                                      self.seasonal_params, 
                                                      self.trend_params)
        
        self.model = ARIMA(y_train, order = self.arima_params,
